...
public class PubSubTopicSubscribeCreatePush extends HttpServlet {
  /**
	 * 
	 */
	private static final long serialVersionUID = -7394260602938306597L;
	
	final Logger LOG = Logger.getLogger(PubSubTopicSubscribeCreatePush.class.getName());
...
@Override
  public void doPost(HttpServletRequest req, HttpServletResponse resp)
	...
	try{
        ...
        String subscription=map.get("substriction");
        ...
        String pushEndpoint = "https://"+Constants.PROJECT_ID+".appspot.com/"+Constants.CLOUD_PUB_SUB_WEBHOOK;
        ...
        Subscription subs = new Subscription()
                ...
                // receives messages
                .setTopic("projects/"+Constants.PROJECT_ID+"/topics/"+topic)
        ...
        Subscription newSubscription = pubsub.projects().subscriptions().create(
        		"projects/"+Constants.PROJECT_ID+"/subscriptions/"+subscription,subs)
                .execute();
        
        String responseToRet = new Gson().toJson(newSubscription.toPrettyString());
        resp.setContentType("application/json");
        resp.getWriter().println(responseToRet);
	  }
	  catch(Exception e){
		// print stack trace
		e.printStackTrace();
