...
public class PubSubTopicDelete extends HttpServlet {
  /**
	 * 
	 */
	private static final long serialVersionUID = -7394260602938306597L;
	
	final Logger LOG = Logger.getLogger(PubSubTopicDelete.class.getName());
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp)
	...
	try{
     ...
     // define HTTP_TRANSPORT and JSON_FACTORY
        ...
        pubsub.projects().topics().delete("projects/"+Constants.PROJECT_ID+"/topics/"+topic).execute();
        
        String responseToRet = new Gson().toJson("Topic " + topic + " correctly removed");
