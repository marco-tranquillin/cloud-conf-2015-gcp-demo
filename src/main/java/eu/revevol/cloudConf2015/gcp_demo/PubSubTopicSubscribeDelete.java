...
public class PubSubTopicSubscribeDelete extends HttpServlet {
  /**
	 * 
	 */
	private static final long serialVersionUID = -7394260602938306597L;
	
	final Logger LOG = Logger.getLogger(PubSubTopicSubscribeDelete.class.getName());
...
@Override
  public void doPost(HttpServletRequest req, HttpServletResponse resp)
	...
	try{
        ...
        //delete subscription
        pubsub.projects().subscriptions().delete("projects/"+Constants.PROJECT_ID+"/subscriptions/"+subscription).execute();
        
        String responseToRet = new Gson().toJson("Subscription " + subscription + " has been correctly deleted.");
