...
public class GetMessageList extends HttpServlet {
  /**
	...
	final Logger LOG = Logger.getLogger(GetMessageList.class.getName());
...
@Override
  public void doGet(HttpServletRequest req, HttpServletResponse resp)
	  ...
	  //get list of message ordered by timestamp
	  ...
	  Comparator<Message> comparator = new Comparator<Message>(){
			...
			public int compare(Message o1, Message o2) {
		        ...
		        return Long.valueOf(o1.getTimestamp())
		            .compareTo(Long.valueOf(o2.getTimestamp()));
			}
		};
		
	  Collections.sort(messageList,comparator);
	  resp.getWriter().print(new Gson().toJson(messageList));
  }
