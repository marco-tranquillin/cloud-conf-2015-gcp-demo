...
public class PubSubTopicPublish extends HttpServlet {
  /**
	 * 
	 */
	private static final long serialVersionUID = -7394260602938306597L;
	
	final Logger LOG = Logger.getLogger(PubSubTopicPublish.class.getName());
...
@Override
  public void doPost(HttpServletRequest req, HttpServletResponse resp)
	...
	try{
        ...
        String responseToRet = new Gson().toJson(messageIds);
