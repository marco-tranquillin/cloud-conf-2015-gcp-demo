...
public class GetInstanceList extends HttpServlet {
  /**
	 * 
	 */
	private static final long serialVersionUID = -7394260602938306597L;
	
	final Logger LOG = Logger.getLogger(GetInstanceList.class.getName());
...
@Override
  public void doGet(HttpServletRequest req, HttpServletResponse resp)
	  ...
	  //get list of message
	  List<Instance> instanceList=ObjectifyService.ofy().load().type(Instance.class).list();
	  resp.getWriter().print(new Gson().toJson(instanceList));
  }
